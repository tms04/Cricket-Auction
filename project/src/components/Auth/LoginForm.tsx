...
const LoginForm: React.FC = () => {
  ...
  const loginCredentials = [
    { role: 'Master', username: 'master', password: 'master123', color: 'bg-purple-500' },
    { role: 'Auctioneer', username: 'auctioneer', password: 'auction123', color: 'bg-blue-500' },
    { role: 'Viewer', username: 'viewer', password: 'viewer123', color: 'bg-green-500' }
  ];
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="flex justify-center">
            <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg">
